 ...
 */
public class SyncFormsV3 extends AsyncTask<Void, Void, String> {
    ...
    public SyncFormsV3(Context context) {
        mContext = context;
    }
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            pd.setMessage(sSynced + " FormsV3 synced." + String.valueOf(json.length() - sSynced) + " Errors: " + sSyncedError);
            pd.setTitle("Done uploading FormsV3 data");
            pd.show();
            ...
            pd.setTitle("FormsV3 Sync Failed");
            pd.show();
        }
    }
    ...
    private String downloadUrl(String myurl) throws IOException {
        ...
        //  int len = 500;
        DatabaseHelper db = new DatabaseHelper(mContext);
        Collection<FormsContract> forms = db.getUnsyncedFormsV3();
